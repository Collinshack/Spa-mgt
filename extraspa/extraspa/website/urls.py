...
urlpatterns = [
    ...
    path('search-physical-card-sum/', views.search_physical_card_sum, name='search_physical_card_sum'),
    path('search-physical-card-service/', views.search_physical_card_service, name='search_physical_card_service'),
    # path('search-electronic-card-service-detail/', views.search_electronic_card_service_detail, name='search_electronic_card_service_detail'),

    path('create-physical-card-sum/', views.generate_physical_card_sum, name='generate_physical_card_sum'),
    ...
    path('physical-card-records-sum/', views.physical_card_sum_records, name='physical_card_sum_records'),
    ...
    path('deduct-physical-sum/<int:pk>/', views.physical_card_sum_deduct_amount, name='physical_card_sum_deduct_amount'),
